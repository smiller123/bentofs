...
struct posix_acl;
struct posix_acl *bento_get_acl(struct inode *inode, int type);
int bento_set_acl(struct inode *inode, struct posix_acl *acl, int type);
